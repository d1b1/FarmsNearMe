...
app({
	appId: '0HSXBL8OUV',
	apiKey: '4cc2571c2b1e6f13d6653ca3cbedda85',
	indexName: 'farms',
});
...
function app(opts) {
				...
				item: `
					<div class="columns" style="padding-top: 20px; padding-bottom: 20px; border-bottom: 1px solid #DFDFDF;">
							...
							<div class="is-four-fifth">
								...
								<h3 class="is-size-3">
									{{{ _highlightResult.farmName.value }}}
	...
	search.addWidget(
		instantsearch.widgets.refinementList({
			container: '#farmType',
			attribute: 'preferences.farmType',
			showMore: false,
			showMoreLimit: 10,
			searchable: false,
			templates: {
	...
	search.addWidget(
		instantsearch.widgets.refinementList({
			container: '#acceptedPayment',
			attribute: 'preferences.acceptedPayment',
			showMore: false,
			showMoreLimit: 10,
			searchable: false,
			templates: {
	...
	// 	instantsearch.widgets.refinementList({
	// 		container: '# ',
	// 		attribute: 'preferences.products',
	// 		showMore: false,
	// 		showMoreLimit: 10,
	// 		searchable: false,
	// 		templates: {
